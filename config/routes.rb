Rails.application.routes.draw do
  ...
  get 'procedure-browser/organisations-accountable-to-parliament/:organisation_accountable_to_parliament/making-availables' => 'organisation_accountable_to_parliament_making_available#index', as: :organisation_accountable_to_parliament_making_available_list
