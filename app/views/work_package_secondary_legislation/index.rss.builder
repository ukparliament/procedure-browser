xml.rss( :version => '2.0', 'xmlns:atom' => 'http://www.w3.org/2005/Atom' ) do
  xml.channel do
    xml.title( "Secondary legislation work packages." )
    xml.description( "Updates whenever a new secondary legislation work package is created." )
	xml.link( work_package_secondary_legislation_list_url )
    ...
    xml.tag!( 'atom:link', { :href => work_package_secondary_legislation_list_url( :format => 'rss' ), :rel => 'self', :type => 'application/rss+xml' } )
