module OrganisationAccountableToParliamentHelper
  ...
  def organisation_accountable_to_parliament_list_pagination_result_numbers( page, results_per_page, result_count )
  
    # We set the from number, being the highest number on the previous page plus one.
    organisation_accountable_to_parliament_list_pagination_result_numbers = ( ( page - 1 ) * results_per_page + 1 ).to_s
    
    # We add the separator.
    organisation_accountable_to_parliament_list_pagination_result_numbers += ' - '
    ...
    if ( page * results_per_page ) > result_count
      ...
      organisation_accountable_to_parliament_list_pagination_result_numbers += result_count.to_s
    ...
    # Otherwise, if the highest number possible on this page does not exceed the total result count.
      ...
      organisation_accountable_to_parliament_list_pagination_result_numbers += ( page * results_per_page ).to_s
    end
    organisation_accountable_to_parliament_list_pagination_result_numbers
  end
  ...
  def organisation_accountable_to_parliament_list_pagination_next_link( page, results_per_page, result_count )
    ...
    if organisation_accountable_to_parliament_list_pagination_has_subsequent_page( page, results_per_page, result_count )
  ...
  def organisation_accountable_to_parliament_list_pagination_has_subsequent_page( page, results_per_page, result_count )
