class OrganisationAccountableToParliamentWorkPackageController < ApplicationController
  ...
  include Sparql::Get::OrganisationAccountableToParliamentWorkPackagesCurrentAll
  include Sparql::Queries::OrganisationAccountableToParliamentWorkPackagesCurrentAll
  ...
  def current
    ...
    @page_title = "Work packages for the #{@organisation_accountable_to_parliament.label} currently before Parliament"
    
    respond_to do |format|
      format.csv {
      
      # We get the set of current work packages made available by an organisation accountable to Parliament.
      @work_packages = get_organisation_accountable_to_parliament_current_work_packages_all( organisation_accountable_to_parliament ) 
