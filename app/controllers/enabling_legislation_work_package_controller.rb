class EnablingLegislationWorkPackageController < ApplicationController
  ...
  include Sparql::Get::EnablingLegislationWorkPackagesAll
  include Sparql::Queries::EnablingLegislationWorkPackagesAll
  ...
  include Sparql::Get::EnablingLegislationWorkPackagesCurrentAll
  include Sparql::Queries::EnablingLegislationWorkPackagesCurrentAll
    ...
    if @enabling_legislation
      ...
      respond_to do |format|
        format.csv {
          ...
          # We get the set of work packages for an item of legislation.
          @work_packages = get_enabling_legislation_work_packages_all( enabling_legislation )
        ...
        format.any( :html, :rss ) {
          ...
          @csv_url = enabling_legislation_work_package_list_url( :format => 'csv' )
    ...
    if @enabling_legislation
      ...
      respond_to do |format|
        format.csv {
          ...
          # We get the set of work packages for an item of legislation.
          @work_packages = get_enabling_legislation_work_packages_current_all( enabling_legislation )
