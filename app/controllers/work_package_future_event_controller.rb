class WorkPackageFutureEventController < ApplicationController
  ...
  def index
    ...
    # We get an array of future events structured for display as nested lists.
    # These are an array of days containing an array of events, containing an array of steps.
    @work_package_future_events = get_past_events_for_work_package( @work_package_events )
