class StepCollectionWorkPackageController < ApplicationController
  ...
  include Sparql::Get::StepCollectionWorkPackagesAll
  include Sparql::Queries::StepCollectionWorkPackagesAll
  ...
  include Sparql::Get::StepCollectionWorkPackagesCurrentAll
  include Sparql::Queries::StepCollectionWorkPackagesCurrentAll
    ...
    if @step_collection
      ...
      respond_to do |format|
        format.csv {
          ...
          # We get the set of work packages for this step collection.
          @work_packages = get_step_collection_work_packages_all( step_collection_id )
        ...
        format.any( :html, :rss ) {
          ...
          @csv_url = step_collection_work_package_list_url( :format => 'csv' )
    ...
    if @step_collection
      ...
      respond_to do |format|
        format.csv {
          ...
          # We get the set of current work packages for this step collection.
          @work_packages = get_step_collection_work_packages_current_all( step_collection_id )
        ...
        format.any( :html, :rss ) {
          ...
          @csv_url = step_collection_work_package_current_list_url( :format => 'csv' )
          @crumb << { label: 'Step collections', url: step_collection_list_url }
          @crumb << { label: @step_collection.label, url: step_collection_show_url }
