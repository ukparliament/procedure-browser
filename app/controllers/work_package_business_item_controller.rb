    ...
    if @work_package
      ...
      respond_to do |format|
        ...
        format.rss {
          ...
          @work_package_business_items = @work_package_past_business_items + @work_package_future_business_items
          
          # We reverse the work package business items array to list reverse chronologically.
          @work_package_business_items.reverse!
        }
