module Sparql::Queries::BusinessItemSteps
  ...
  def business_item_steps_query( business_item_id )
    "
      ...
      SELECT ?businessItem ?workPackage ?workPackagedThing ?workPackagedThingLabel ?procedure ?procedureLabel ?calculationStyle ?calculationStyleLabel ?madeAvailableDate ?businessItemstep ?businessItemStepName ?Date ?url ?legislature ?legislatureName ?CommonsId ?LordsId WHERE {
