module Sparql::Queries::OrganisationAccountableToParliamentTreatyWorkPackagesCurrentAll

  # A SPARQL query to get a list of current work packages for treaties lead by an organisation accountable to Parliament.
  def organisation_accountable_to_parliament_treaty_work_packages_current_all_query( organisation_accountable_to_parliament_id )
    "
