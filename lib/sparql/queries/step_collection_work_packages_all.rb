module Sparql::Queries::StepCollectionWorkPackagesAll

  # A SPARQL query to get all work packages for a step collection.
  def step_collection_work_packages_all_query( step_collection_id )
    "
