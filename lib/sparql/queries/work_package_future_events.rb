module Sparql::Queries::WorkPackageFutureEvents

  # A SPARQL query to get a work package and its future events.
  def work_package_future_events_query( work_package_id )
    "
