module Sparql::Queries::OrganisationAccountableToParliamentWorkPackagesAll

  # A SPARQL query to get all work packages made available by an organisation accountable to Parliament.
  def organisation_accountable_to_parliament_work_packages_all_query( organisation_accountable_to_parliament_id )
    "
