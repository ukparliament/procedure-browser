module Sparql::Queries::OrganisationAccountableToParliamentTreatyWorkPackagesAll

  # A SPARQL query to get a list of all work packages for treaties lead by an organisation accountable to Parliament.
  def organisation_accountable_to_parliament_treaty_work_packages_all_query( organisation_accountable_to_parliament_id )
    "
