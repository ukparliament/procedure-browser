module Sparql::Queries::OrganisationAccountableToParliamentWorkPackagesCurrentAll

  # A SPARQL query to get all current work packages made available by an organisation accountable to Parliament.
  def organisation_accountable_to_parliament_work_packages_current_all_query( organisation_accountable_to_parliament_id )
    "
