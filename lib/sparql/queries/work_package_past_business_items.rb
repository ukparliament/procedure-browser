module Sparql::Queries::WorkPackagePastBusinessItems

  # A SPARQL query to get a work package and its past business items.
  def work_package_past_business_items_query( work_package_id )
    "
