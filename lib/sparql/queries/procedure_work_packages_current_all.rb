module Sparql::Queries::ProcedureWorkPackagesCurrentAll

  # A SPARQL query to get all current work packages for a procedure.
  def procedure_work_packages_current_all_query( procedure_id )
    "
