module Sparql::Queries::CalculationStyleWorkPackagesCurrent

  # A SPARQL query to get current work packages for a calculation style.
  def calculation_style_work_packages_current_query( calculation_style_id, limit, offset )
    [
      # The title of the SPARQL query.
      "A list of a calculation style's current work packages with limit and offset for pagination",

      # The link to the SPARQL query.
      'https://api.parliament.uk/s/3cf6b6b8',
