module Sparql::Queries::StepCollectionWorkPackagesCurrentAll

  # A SPARQL query to get all current work packages for a step collection.
  def step_collection_work_packages_current_all_query( step_collection_id )
    "
