module Sparql::Get::ProcedureStepsWithDepths
  
  def get_procedure_steps_with_depths( procedure )
    
    # We get the procedure steps with depths query.
    request_body = procedure_steps_with_depths_query( procedure )
