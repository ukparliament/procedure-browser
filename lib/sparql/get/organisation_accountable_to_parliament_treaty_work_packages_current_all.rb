module Sparql::Get::OrganisationAccountableToParliamentTreatyWorkPackagesCurrentAll
  
  def get_organisation_accountable_to_parliament_treaty_work_packages_current_all( organisation_accountable_to_parliament_id )
  
    # We get the organisation accountable to parliament treaty work packages current query.
    request_body = organisation_accountable_to_parliament_treaty_work_packages_current_all_query( organisation_accountable_to_parliament_id )
