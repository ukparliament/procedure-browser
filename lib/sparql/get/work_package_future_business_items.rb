module Sparql::Get::WorkPackageFutureBusinessItems

  # A method to get a work package and its future business items.
  def get_work_package_future_business_items( work_package_id )
  
    # We get the work package future business items query.
    request_body = work_package_future_business_items_query( work_package_id )
