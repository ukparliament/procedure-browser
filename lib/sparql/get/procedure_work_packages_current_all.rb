module Sparql::Get::ProcedureWorkPackagesCurrentAll
  
  def get_procedure_work_packages_current_all( procedure )
    
    # We get the all current procedure work packages query.
    request_body = procedure_work_packages_current_all_query( procedure )
