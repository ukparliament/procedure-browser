module Sparql::Get::CalculationStyleWorkPackagesCurrentAll
  
  def get_calculation_style_work_packages_current_all( calculation_style )
    
    # We get the calculation style work packages query.
    request_body = calculation_style_work_packages_current_all_query( calculation_style )
