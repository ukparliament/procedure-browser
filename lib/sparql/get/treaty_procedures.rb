module Sparql::Get::TreatyProcedures

  # A method to get an array of treaty procedures.
  def get_treaty_procedures

    # We get the treaty procedures query.
    request_body = treaty_procedures_query
