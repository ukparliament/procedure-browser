module Sparql::Get::EnablingLegislationWorkPackagesCurrentAll
  
  def get_enabling_legislation_work_packages_current_all( enabling_thing_id )
  
    
    # We get the enabling legislation current work packages query.
    request_body = enabling_legislation_work_packages_current_all_query( enabling_thing_id )
