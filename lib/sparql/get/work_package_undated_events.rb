module Sparql::Get::WorkPackageUndatedEvents

  # A method to get a work package and its undated events.
  def get_work_package_undated_events( work_package_id )
  
    # We get the work package undated events query.
    request_body = work_package_undated_events_query( work_package_id )
