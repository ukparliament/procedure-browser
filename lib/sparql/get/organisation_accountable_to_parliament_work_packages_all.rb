module Sparql::Get::OrganisationAccountableToParliamentWorkPackagesAll
  
  def get_organisation_accountable_to_parliament_work_packages_all( organisation_accountable_to_parliament_id )
  
    # We get the organisation accountable to parliament all work packages query.
    request_body = organisation_accountable_to_parliament_work_packages_all_query( organisation_accountable_to_parliament_id )
