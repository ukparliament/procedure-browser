module Sparql::Get::WorkPackageBusinessItems

  # A method to get a work package and its business items.
  def get_work_package_business_items( work_package_id )
  
    # We get the work package business items query.
    request_body = work_package_business_items_query( work_package_id )
