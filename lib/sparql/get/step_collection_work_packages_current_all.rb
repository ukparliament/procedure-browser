module Sparql::Get::StepCollectionWorkPackagesCurrentAll
  
  def get_step_collection_work_packages_current_all( step_collection )
    
    # We get the current step collection all work packages query.
    request_body = step_collection_work_packages_current_all_query( step_collection )
