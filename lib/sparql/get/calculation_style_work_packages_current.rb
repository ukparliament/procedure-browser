module Sparql::Get::CalculationStyleWorkPackagesCurrent
  
  def get_calculation_style_work_packages_current( calculation_style, page_number, results_per_page )
    ...
    request_body = calculation_style_work_packages_current_query( calculation_style, results_per_page, result_offset )
