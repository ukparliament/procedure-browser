module Sparql::Get::PrimaryLegislationWorkPackages

  # A method to get an array of all primary legislation work packages on this page with this many results per page.
  def get_primary_legislation_work_packages( page_number, results_per_page )
    ...
    request_body = primary_legislation_work_packages_query( results_per_page, result_offset )
