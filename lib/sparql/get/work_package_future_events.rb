module Sparql::Get::WorkPackageFutureEvents

  # A method to get a work package and its future events.
  def get_work_package_future_events( work_package_id )
  
    # We get the work package past events query.
    request_body = work_package_future_events_query( work_package_id )
