module Sparql::Get::WorkPackagesCurrentAll

  # A method to get an array of current work packages.
  def get_work_packages_current_all

    # We get the current work packages query.
    request_body = work_packages_current_all_query
