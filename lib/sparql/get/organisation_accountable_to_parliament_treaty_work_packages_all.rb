module Sparql::Get::OrganisationAccountableToParliamentTreatyWorkPackagesAll
  
  def get_organisation_accountable_to_parliament_treaty_work_packages_all( organisation_accountable_to_parliament_id )
  
    # We get the organisation accountable to parliament treaty work packages all query.
    request_body = organisation_accountable_to_parliament_treaty_work_packages_all_query( organisation_accountable_to_parliament_id )
